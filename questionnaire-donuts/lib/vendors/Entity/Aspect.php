...
class Aspect extends Entity  
{
	...
	public function setUniqueIdAspect($uniqueIdAspect)
	{
		
		$this->uniqueIdAspect = $uniqueIdAspect;

	}

	public function getUniqueIdAspect()
	{
		return $this->uniqueIdAspect ;
	}
